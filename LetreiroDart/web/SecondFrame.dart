...
class SecondFrame extends Frame {
  ...
  CanvasImageSource drawFrame() {
    ...
    // FLAP
    int flapSize = (height * 0.4).toInt();
    cx.setFillColorRgb(0, 0, 0);
    cx.fillRect(0, (canvas.height/2) - flapSize, canvas.width, flapSize);
    
    CanvasImageSource flapLetter = drawFlapLetter(width, (height * 0.6).toInt(), oldLetter);
